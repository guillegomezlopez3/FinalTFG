...
public class WorkoutPlanResponse {
    ...
    public List<WorkoutDayResponse> getWorkoutDays() { return workoutDays; }
    public void setWorkoutDays(List<WorkoutDayResponse> workoutDays) { this.workoutDays = workoutDays; }
}
